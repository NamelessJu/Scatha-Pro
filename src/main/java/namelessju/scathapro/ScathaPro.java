...
@Mod(
    modid = ScathaPro.MODID,
    version = ScathaPro.VERSION,
    name = ScathaPro.TRUE_MODNAME,
    clientSideOnly = true,
    guiFactory = "namelessju.scathapro.ForgeConfigGuiFactory"
)
public class ScathaPro
{
    ...
    private final AlertTitleOverlay alertTitleOverlay;
    private final AlertModeManager alertModeManager;
    private final CustomAlertModeManager customAlertModeManager;
    private final AchievementManager achievementManager;
    private final AchievementLogicManager achievementLogicManager;
    private final InputManager inputManager;
    private final ChestGuiParsingManager chestGuiParsingManager;
