...
public abstract class ScathaProGui extends GuiScreen
{
    ...
    public static void drawTooltip(int mouseX, int mouseY, String[] textLines, int maxTextWidth)
    {
        Minecraft mc = Minecraft.getMinecraft();
        drawTooltip(mc.currentScreen, mc.fontRendererObj, mouseX, mouseY, textLines, maxTextWidth);
    }
