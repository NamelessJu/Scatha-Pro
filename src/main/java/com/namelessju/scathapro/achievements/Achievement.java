...
public enum Achievement
{
    ...
    worm_kills_6("Can't stop now", "Kill 25,000 worms", 25000, Type.BONUS),
    ...
    kill_weapons_regular_worm("Variety gamer", "Kill a regular worm using 5 different weapons", 5, Type.SECRET), // TODO: name not great
    ...
    scatha_kill_juju("April Fools '24", "Kill a Scatha with a Juju Shortbow", 1, Type.HIDDEN),
