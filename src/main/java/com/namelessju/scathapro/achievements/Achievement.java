...
public enum Achievement
{
    ...
    worm_kills_6(AchievementCategory.KILL_AMOUNTS, "Don't stop me now", "Kill 25,000 worms", 25000, Type.BONUS),
    ...
    scatha_pet_drop_dry_streak_2(AchievementCategory.SCATHA_PET_DROPS, "404 Scatha pet not found", "Go 404 Scatha kills without dropping a pet", 404, Type.HIDDEN),
    
    scatha_pet_drop_b2b(AchievementCategory.SCATHA_PET_DROPS, "Sold your soul to RNGesus", "Drop two Scatha pets back to back", 2, Type.HIDDEN),
    ...
    hard_stone_mined_1(AchievementCategory.HARD_STONE, "Rock solid", "Mine 1,000,000 hard stone", 1000000, Type.LEGACY),
    hard_stone_mined_2(AchievementCategory.HARD_STONE, "Stoned", "Mine 10,000,000 hard stone", 10000000, Type.LEGACY),
    hard_stone_mined_3(AchievementCategory.HARD_STONE, "Crystal hollowed", "Mine 100,000,000 hard stone", 100000000, Type.LEGACY),
    ...
    crystal_hollows_time_3(AchievementCategory.LOBBY_TIMER, "Touch some grass", "Spend 5 hours in a single Crystal Hollows lobby", 5, Type.BONUS),
    ...
    lobby_kills_3(AchievementCategory.TIMEFRAME_KILLS, "Lobby cleared", "Kill 100 worms in a single lobby", 100, Type.BONUS),
    
    day_kills_1(AchievementCategory.TIMEFRAME_KILLS, "A good day for killing worms", "Kill 50 worms in a single (IRL) day", 50),
    day_kills_2(AchievementCategory.TIMEFRAME_KILLS, "On today's agenda: Scatha farming", "Kill 100 worms in a single (IRL) day", 100),
    day_kills_3(AchievementCategory.TIMEFRAME_KILLS, "Full time job", "Kill 250 worms in a single (IRL) day", 250, Type.BONUS),
    ...
    regular_worm_streak_1(AchievementCategory.SPAWN_STREAK, "Still perfectly normal", "Get 7 regular worm spawns in a row (in 1 lobby)", 7),
    regular_worm_streak_2(AchievementCategory.SPAWN_STREAK, "Unlucky number", "Get 13 regular worm spawns in a row (in 1 lobby)", 13),
    regular_worm_streak_3(AchievementCategory.SPAWN_STREAK, "Scathas are on vacation", "Get 20 regular worm spawns in a row (in 1 lobby)", 20),
    
    scatha_streak_1(AchievementCategory.SPAWN_STREAK, "This is getting out of hand", "Get 2 Scatha spawns back to back (in 1 lobby)", 2),
    scatha_streak_2(AchievementCategory.SPAWN_STREAK, "Oh baby a triple!", "Get 3 Scatha spawns back to back (in 1 lobby)", 3),
    scatha_streak_3(AchievementCategory.SPAWN_STREAK, "Four Scatha clover", "Get 4 Scatha spawns back to back (in 1 lobby)", 4),
    scatha_streak_4(AchievementCategory.SPAWN_STREAK, "Scatha Magnet", "Get 5 Scatha spawns back to back (in 1 lobby)", 5),
