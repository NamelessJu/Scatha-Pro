...
public class OverlayScathaPercentageSettingsGui extends OverlaySettingsGui implements GuiSlider.ISlider
{
    ...
    public void initGui()
    {
        ...
        elements.add(new ScathaProSlider(3, width / 2 + 5, height - 45 - 48 - 6, 150, 20, "Percentage Duration: ", "s", 1, 10, config.getInt(Config.Key.scathaPercentageCyclePercentageDuration), false, true, this));
