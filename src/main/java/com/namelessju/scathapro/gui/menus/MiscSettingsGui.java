...
public class MiscSettingsGui extends ScathaProGui
{
    ...
    public void initGui()
    {
        ...
        buttonList.add(new MultiOptionButton<Integer>(504704806, width / 2 + 5, height / 6 + 24 - 12, 150, 20, "Rot. Angles Dec. Places", MultiOptionButton.IntegerOption.range(0, 3), config.getInt(Config.Key.rotationAnglesDecimalDigits), new MultiOptionButton.IOptionChangedListener<Integer>() {
            @Override
