...
public class ChatParser
{
    ...
    private void parseMessage(@NonNull String unformattedText)
    {
        ...
        if ("Warping...".equals(unformattedText))
        {
            ...
            if (stewString != null)
            {
                ...
                for (WitchesStew stew : WitchesStew.values())
                {
                    if (stew.stewName.equalsIgnoreCase(stewString))
                    {
                        ...
                        {
                            scathaPro.runNextTick(() -> scathaPro.chatManager.sendChatMessage(Component.empty().withStyle(ChatFormatting.GRAY)
    ...
    {
        Component extendedPetDropMessage = scathaPro.chatManager.extendPetDropMessage(original, unformattedText, true);
