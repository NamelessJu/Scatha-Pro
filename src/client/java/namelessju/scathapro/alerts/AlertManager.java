...
public class AlertManager implements Iterable<Alert>
{
    ...
    public AlertManager(ScathaPro scathaPro)
    {
        ...
        oldLobbyAlert = register(new Alert("old_lobby", "Old Crystal Hollows Lobby Alert", null,
            SoundData.vanilla("block.note_block.pling", 1f, 0.5f),
            new FullAlertTitleTemplate(
                "Old Lobby", null,
        ...
        scathaSpawnAlert = register(new Alert("scatha_spawn", "Scatha Spawn Alert", null,
        ...
        wormSpawnCooldownEndAlert = register(new Alert("worm_spawn_cooldown_end", "Worm Spawn Cooldown Alert",
        ...
        tunnelVisionReadyAlert = register(new Alert("anomalous_desire_ready", "Tunnel Vision Ready Alert",
        ...
        jerrySpawnAlert = register(new Alert("jerry_spawn", "Hidden Jerry Spawn Alert",
