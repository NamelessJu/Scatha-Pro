...
public enum AchievementType
{
    ...
    SECRET("Secret", Style.EMPTY.withColor(TextColor.AQUA), LockedVisibility.TITLE_ONLY,
        SoundData.scathaPro("achievements.unlock", 0.9f, 0.749154f)),
    BONUS("BONUS", Style.EMPTY.withColor(TextColor.YELLOW), LockedVisibility.HIDDEN,
        SoundData.vanilla("ui.toast.challenge_complete", 0.75f, 1.259921f)),
    HIDDEN("HIDDEN", Style.EMPTY.withColor(TextColor.RED), LockedVisibility.HIDDEN,
        SoundData.vanilla("ui.toast.challenge_complete", 0.75f, 0.749154f)),
    LEGACY("LEGACY", Style.EMPTY.withColor(TextColor.DARK_PURPLE), LockedVisibility.HIDDEN, null);
