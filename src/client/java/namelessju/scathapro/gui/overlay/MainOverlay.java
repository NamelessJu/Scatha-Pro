...
public class MainOverlay
{
    ...
    private void initializeElements()
    {
        ...
        addToggleableElement("Scatha Farming Profile Stats", profileStatsText, elementStatesConfig.profileStatsShown,
            Component.literal("\"/" + scathaPro.mainCommand.getCommandName() + " profileStats\"\nto update values")
                .withStyle(Style.EMPTY.withColor(TextColor.YELLOW).withItalic(true)));
    ...
    public void updateScathaKills()
    {
        ...
        else
        {
            ...
            scathaKillsText.setText(Component.empty()
                ...
                .append("%"));
            secondaryScathaKillsText.setText(Component.empty().withColor(TextUtil.contrastableGray(scathaPro))
    ...
    private void updateTotalKills()
    {
        ...
        if (scathaPro.config.overlay.scathaPercentageAlternativePositionEnabled.get())
        {
            ...
            String scathaPercentageString = scathaPercentage >= 100f ? "100" : (scathaPercentage <= 0f ? "0" : TextUtil.numberToString(scathaPercentage, scathaPercentageDecimalPlaces, true));
            String secondaryScathaPercentageString = secondaryScathaPercentage >= 100f ? "100" : (secondaryScathaPercentage <= 0f ? "0" : TextUtil.numberToString(secondaryScathaPercentage, scathaPercentageDecimalPlaces, true));
            if (scathaPercentage >= 0) scathaPercentageComponent = Component.literal(" (" + scathaPercentageString + "%)").withColor(contrastableGray);
            if (secondaryScathaPercentage >= 0) secondaryScathaPercentageComponent = Component.literal(" (" + secondaryScathaPercentageString + "%)").withColor(contrastableGray);
        }
    ...
    private void updateLobbyTime()
    {
        ...
        lobbyTimeText.setText(Component.empty()
            ...
            .append(Component.literal(
                ...
                ).withColor(TextUtil.contrastableGray(scathaPro)))
        );
    }
    ...
    private void updateCoords()
    {
        ...
        coordsText.setText(Component.empty()
            .append(Component.literal(coordinatesString + " " + facingAxisString + ": ").withColor(contrastableGray))
    ...
    private void updateSpawnCooldown()
    {
        ...
        else
        {
            ...
            spawnCooldownTimerText.setText(Component.literal(icon(UnicodeSymbol.heavyCheckMark) + "Worms ready to spawn").withColor(TextColor.GREEN));
        }
    }

    private void updateTunnelVision()
    {
        final Component abilityName = Component.literal("Tunnel Vision").withColor(TextColor.GOLD);
        ...
        if (
            ...
            tunnelVisionStatusText.setText(Component.empty()
                .append(Component.literal(icon(UnicodeSymbol.lightingBolt)).withColor(TextColor.YELLOW))
                .append(abilityName)
        ...
        else
        {
            ...
            {
                tunnelVisionStatusText.setText(Component.empty()
                    .append(Component.literal(icon(UnicodeSymbol.hourglass)).withColor(TextColor.RED))
                    .append(abilityName)
            ...
            {
                tunnelVisionStatusText.setText(Component.empty()
                    .append(Component.literal(icon(UnicodeSymbol.heavyCheckMark)).withColor(TextColor.GREEN))
                    .append(abilityName).append(Component.literal(" available").withColor(TextColor.GREEN))
                );
            }
        }
    ...
    public void updateProfileStats()
    {
        ...
        profileStatsText.setText(Component.empty()
            ...
            .append(Component.literal(" ").withColor(contrastableGray))
