...
public class OverlayDynamicContainer extends OverlayContainer
{
                                      ...
                                      int defaultX, int defaultY, OverlayElement.@Nullable Alignment contentAlignment)
    {
        ...
        else
        {
            ...
            {
                if (0.495f <= screenXPercentage && screenXPercentage < 0.505f) setContentAlignment(OverlayElement.Alignment.CENTER);
                else if (screenXPercentage > 0.5f) setContentAlignment(OverlayElement.Alignment.RIGHT);
            }
        }
    }
}